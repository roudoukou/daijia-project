...
public class MapServiceImpl implements MapService {
    ...
    public DrivingLineVo calculateDrivingLine(CalculateDrivingLineForm calculateDrivingLineForm) {
        ...
        // 写死
        DrivingLineVo drivingLineVo = new DrivingLineVo();
        drivingLineVo.setDuration(new BigDecimal(16));
        drivingLineVo.setDistance(new BigDecimal("6.4"));
        JSONArray polyline = new JSONArray();
        // 起点：华南理工大学(五山校区)
        polyline.add("23.09,113.30");
        // 中间点
        polyline.add("23.10,113.31");
        // 中间点
        polyline.add("23.11,113.32");
        // 终点：正佳广场
        polyline.add("23.12,113.33");
